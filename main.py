...
BOT_NAME = os.environ.get("BOT_NAME", "Haruka Music")
BOT_LINK = os.environ.get("BOT_LINK", "https://t.me/HARUKA_06_BOT")
...
async def start_handler(_, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(f"📢 {updates_text}", url="https://t.me/HARUKA_06_BOT")
        ],
        [
            InlineKeyboardButton(f"💬 {support_text}", url="https://https://t.me/JAVANON_KA_ADDA"),
...
async def go_back_callback(_, callback_query):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(f"💬 {support_text}", url="https://t.me/JAVANON_KA_ADDA"),
            InlineKeyboardButton(f"❓ {help_text}", callback_data="show_help")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
