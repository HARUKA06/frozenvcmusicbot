...
API_ID = int(getenv("28487420", None))
API_HASH = getenv("2ded01d66903a024b83b80dd50ecc4d6", None)

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("7989152718:AAFBPf1MNoGj-1SSSw3LAPcMGnQtAwv8cQU", None)
